...
public record ScriptUnknownArgument() implements ScriptArgument {
    ...
    public ItemStack getArgIcon() {
        ItemStack result = new ItemStack(Items.LIGHT_GRAY_DYE);
        result.set(DataComponentTypes.CUSTOM_NAME, Text.literal("Unknown").setStyle(Style.EMPTY.withColor(Formatting.WHITE).withItalic(false)));
        return result;
    }
